...
#define STEP_MASK       (0) // All step bits
...
#define DIRECTION_MASK    (0) // All direction bits
...
#endif
#define LIMIT_MASK       (0) // All limit bits
...
#define COOLANT_FLOOD_BIT   -1  // Uno Analog Pin 3
...
#define RESET_BIT         -1  // Uno Analog Pin 0
#define FEED_HOLD_BIT     -1  // Uno Analog Pin 1
#define CYCLE_START_BIT   -1  // Uno Analog Pin 2
